...
screen.connect_signal("request::desktop_decoration", function(s)
	...
	-- Changed default layout to "fair" via layouts[4]
	...
	s.mywibox = awful.wibar({
		...
		widget = {
			...
			s.mytaglist,
			{
				...
				wibox.container.margin(s.mylayoutbox, 4, 4),
...
awful.spawn.with_shell("feh --bg-fill ~/.config/wallpapers/tenki-no-ko-2k.png")
